      ...
      <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse align-content-end" id="navbarTogglerDemo02">
            ...
            <ul class="navbar-nav me-10 mb-2">
              ...
              @guest
              <li class="nav-item">
                <a role="button" class="btn btn-pers btn-lg" href="{{ url('/login') }}">Iniciar sesion</a>
              </li>
              <li class="nav-item">
                <a role="button" class="btn btn-pers green btn-lg" href="{{ url('/register') }}">Registrate</a>
              </li> 
      ...
      <div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
        <div class="carousel-inner">
          ...
          <div class="carousel-item">
            <div class="sobreponer-carr izquierda d-flex texto-sobrepuesto">
